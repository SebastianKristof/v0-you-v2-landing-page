    ...
    <section id="ready-to-choose" className={`w-full py-16 ${sectionBackgrounds.readyToChoose}`}>
      <div className="section-container">
        <ScrollReveal className="mx-auto max-w-[700px] space-y-8 md:space-y-12 text-center">
          ...
          <a
            href="#book"
            className={`executive-button text-lg px-8 py-4 mb-4 inline-block text-executive-dark border-0 hover:bg-executive-gold transition-colors ${sectionBackgrounds.readyToChooseCta}`}
          >
            {t("readyToChoose.cta")}
          </a>
